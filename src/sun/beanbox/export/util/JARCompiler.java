...
public class JARCompiler {
     ...
     */
    private static String getRelativePath(String base, File file, boolean leadingSlash) {
    ...
    public static void compileSources(File folder, Collection<File> resources) {
        ...
        Iterable<String> options = Arrays.asList("-classpath", classpath.toString(), "-Xlint");
